...
def get_users(keywords):
    ...
    tdf['textBlob_polarity'] = tdf['stemm_tweets'].apply(polarity_score_textBlob)
    tdf['sentiment_textblob'] = tdf['textBlob_polarity'].apply(sentiment)
...
def polarity_score_textBlob(example):
